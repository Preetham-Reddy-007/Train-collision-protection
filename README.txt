...
Main Code:
----------
    |->   client_rpi1.py -> Code to be run on rpi1       -> includes the rfid portion as well
    |->   client_rpi2.py -> Code to be run on rpi2       -> includes the rfid portion as well
    |->   server_rpi.py  -> Code with ip of rpi
...
------------
    |->   client.py (only basic features with random data)     -> Clients and test case emulator     -> Loopback address used
    |->   server.py (only basic features with random data)     -> For clients and test case emulator -> Server code with loopback address 
